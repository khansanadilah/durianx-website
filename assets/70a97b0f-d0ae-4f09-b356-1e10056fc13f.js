...
(function () {
  ...
  function loadCOBE() {
    ...
    // Re-read the source each attempt: in a large offline bundle window.__resources
    // is populated only after unpack finishes, which can take many seconds — so keep
    // retrying (re-checking for the inlined blob) rather than giving up early.
